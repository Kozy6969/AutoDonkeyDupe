...
public class donkey extends Module {
    public donkey() {
        super(Helium.CATEGORY, "donkey", "auto open donkey inv");
    }
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        if (hose != null) {
if (timer <= 0) {
mc.getNetworkHandler().sendPacket(PlayerInteractEntityC2SPacket.interact(hose, true, mc.player.getActiveHand()));
timer = delay.get();
}
else{
timer--;
